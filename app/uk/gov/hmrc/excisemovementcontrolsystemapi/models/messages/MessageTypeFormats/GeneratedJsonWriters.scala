...
trait GeneratedJsonWriters {
  ...
  implicit val SubmissionType: Writes[SubmissionType] = Writes[SubmissionType] {
    submissionType => JsString(submissionType.toString)
  }
  implicit val Flag: Writes[Flag] = Writes[Flag] {
  ...
  implicit val PlaceOfDispatchTraderTypeType: OWrites[PlaceOfDispatchTraderTypeType] = Json.writes[PlaceOfDispatchTraderTypeType]

  implicit val DispatchImportOfficeType: OWrites[DispatchImportOfficeType] = Json.writes[DispatchImportOfficeType]

  implicit val ComplementConsigneeTraderType: OWrites[ComplementConsigneeTraderType] = Json.writes[ComplementConsigneeTraderType]

  implicit val DeliveryPlaceTraderTypeType4: OWrites[DeliveryPlaceTraderTypeType4] = Json.writes[DeliveryPlaceTraderTypeType4]

  implicit val DeliveryPlaceCustomsOfficeTypeType3: OWrites[DeliveryPlaceCustomsOfficeTypeType3] = Json.writes[DeliveryPlaceCustomsOfficeTypeType3]

  implicit val CompetentAuthorityDispatchOfficeTypeType: OWrites[CompetentAuthorityDispatchOfficeTypeType] = Json.writes[CompetentAuthorityDispatchOfficeTypeType]
  implicit val TransportArrangerTraderTypeType: OWrites[TransportArrangerTraderTypeType] = Json.writes[TransportArrangerTraderTypeType]
  implicit val FirstTransporterTraderTypeType: OWrites[FirstTransporterTraderTypeType] = Json.writes[FirstTransporterTraderTypeType]
  implicit val LSDReferenceOfDocumentTypeType: OWrites[LSDReferenceOfDocumentTypeType] = Json.writes[LSDReferenceOfDocumentTypeType]

  implicit val DestinationTypeCode: Writes[DestinationTypeCode] = Writes[DestinationTypeCode] {
    code => JsString(code.toString)
  }

  implicit val LSDComplementaryInformationTypeType10: OWrites[LSDComplementaryInformationTypeType10] = Json.writes[LSDComplementaryInformationTypeType10]

  implicit val GuarantorTypeCode: Writes[GuarantorTypeCode] = Writes[GuarantorTypeCode] {
    code => JsString(code.toString)
  }

  implicit val LSDFiscalMarkTypeType2: OWrites[LSDFiscalMarkTypeType2] = Json.writes[LSDFiscalMarkTypeType2]
  implicit val LSDDesignationOfOriginTypeType: OWrites[LSDDesignationOfOriginTypeType] = Json.writes[LSDDesignationOfOriginTypeType]
  ...
  implicit val TransportArrangement: Writes[TransportArrangement] = Writes[TransportArrangement] {
  ...
  implicit val LSDOtherInformationTypeType: OWrites[LSDOtherInformationTypeType] = Json.writes[LSDOtherInformationTypeType]

  implicit val CategoryOfWineProduct: Writes[CategoryOfWineProduct] = Writes[CategoryOfWineProduct] {
    cat => JsString(cat.toString)
  }
  implicit val OriginTypeCode: Writes[OriginTypeCode] = Writes[OriginTypeCode] {
    code => JsString(code.toString)
  }
  ...
  implicit val DocumentCertificateTypeType: OWrites[DocumentCertificateTypeType] = Json.writes[DocumentCertificateTypeType]
  implicit val SubmittedDraftOfEADESADType: OWrites[SubmittedDraftOfEADESADType] = Json.writes[SubmittedDraftOfEADESADType]
  ...
  implicit val FunctionalErrorCodesType: Writes[FunctionalErrorCodesType] = Writes[FunctionalErrorCodesType] {
    code => JsString(code.toString)
  }
  ...
  implicit val LSDSealInformationTypeType4: OWrites[LSDSealInformationTypeType4] = Json.writes[LSDSealInformationTypeType4]
  ...
  implicit val LSDComplementaryInformationTypeType8: OWrites[LSDComplementaryInformationTypeType8] = Json.writes[LSDComplementaryInformationTypeType8]
  ...
  implicit val TransportArrangerTraderType: OWrites[TransportArrangerTraderType] = Json.writes[TransportArrangerTraderType]
  implicit val CompetentAuthorityDispatchOfficeType: OWrites[CompetentAuthorityDispatchOfficeType] = Json.writes[CompetentAuthorityDispatchOfficeType]
  implicit val DeliveryPlaceCustomsOfficeTypeType2: OWrites[DeliveryPlaceCustomsOfficeTypeType2] = Json.writes[DeliveryPlaceCustomsOfficeTypeType2]
  implicit val DeliveryPlaceTraderTypeType3: OWrites[DeliveryPlaceTraderTypeType3] = Json.writes[DeliveryPlaceTraderTypeType3]
  ...
  implicit val ReminderMessageType: Writes[ReminderMessageType] = Writes[ReminderMessageType] {
    t => JsString(t.toString)
  }
  ...
  implicit val ReminderMessageForExciseMovementType: OWrites[ReminderMessageForExciseMovementType] = Json.writes[ReminderMessageForExciseMovementType]
  ...
  implicit val NotificationType: Writes[NotificationType] = Writes[NotificationType] {
    t => JsString(t.toString)
  }
  ...
  implicit val NotificationOfDivertedEADESADType: OWrites[NotificationOfDivertedEADESADType] = Json.writes[NotificationOfDivertedEADESADType]
  ...
  implicit val LSDComplementaryInformationTypeType6: OWrites[LSDComplementaryInformationTypeType6] = Json.writes[LSDComplementaryInformationTypeType6]
  ...
  implicit val LSDComplementaryInformationTypeType9: OWrites[LSDComplementaryInformationTypeType9] = Json.writes[LSDComplementaryInformationTypeType9]
  ...
  implicit val DeliveryPlaceCustomsOfficeTypeType: OWrites[DeliveryPlaceCustomsOfficeTypeType] = Json.writes[DeliveryPlaceCustomsOfficeTypeType]
  implicit val DeliveryPlaceTraderTypeType2: OWrites[DeliveryPlaceTraderTypeType2] = Json.writes[DeliveryPlaceTraderTypeType2]
  implicit val NewConsigneeTraderTypeType: OWrites[NewConsigneeTraderTypeType] = Json.writes[NewConsigneeTraderTypeType]
  implicit val LSDSealInformationTypeType2: OWrites[LSDSealInformationTypeType2] = Json.writes[LSDSealInformationTypeType2]
  implicit val ChangedDestinationTypeCode: Writes[ChangedDestinationTypeCode] = Writes[ChangedDestinationTypeCode] {
    code => JsString(code.toString)
  }
  implicit val LSDComplementaryInformationTypeType5: OWrites[LSDComplementaryInformationTypeType5] = Json.writes[LSDComplementaryInformationTypeType5]
  implicit val TransportDetailsTypeType2: OWrites[TransportDetailsTypeType2] = Json.writes[TransportDetailsTypeType2]
  implicit val NewTransporterTraderTypeType2: OWrites[NewTransporterTraderTypeType2] = Json.writes[NewTransporterTraderTypeType2]
  ...
  implicit val NewTransportArrangerTraderTypeType2: OWrites[NewTransportArrangerTraderTypeType2] = Json.writes[NewTransportArrangerTraderTypeType2]
  ...
  implicit val BodyReportOfReceiptExportType: OWrites[BodyReportOfReceiptExportType] = Json.writes[BodyReportOfReceiptExportType]
  ...
  implicit val DeliveryPlaceTraderTypeType: OWrites[DeliveryPlaceTraderTypeType] = Json.writes[DeliveryPlaceTraderTypeType]
  ...
  implicit val AcceptedOrRejectedReportOfReceiptExportType: OWrites[AcceptedOrRejectedReportOfReceiptExportType] = Json.writes[AcceptedOrRejectedReportOfReceiptExportType]
  ...
  implicit val LSDComplementaryInformationTypeType11: OWrites[LSDComplementaryInformationTypeType11] = Json.writes[LSDComplementaryInformationTypeType11]
  implicit val AlertOrRejectionOfEadEsadReasonType: OWrites[AlertOrRejectionOfEadEsadReasonType] = Json.writes[AlertOrRejectionOfEadEsadReasonType]
  ...
  implicit val AlertOrRejectionOfEADESADType: OWrites[AlertOrRejectionOfEADESADType] = Json.writes[AlertOrRejectionOfEADESADType]
  ...
  implicit val NotificationOfAcceptedExportType: OWrites[NotificationOfAcceptedExportType] = Json.writes[NotificationOfAcceptedExportType]
  ...
  implicit val MessageRoleCode: Writes[MessageRoleCode] = Writes[MessageRoleCode] {
    code => JsString(code.toString)
  }
  implicit val LSDComplementaryInformationTypeType2: OWrites[LSDComplementaryInformationTypeType2] = Json.writes[LSDComplementaryInformationTypeType2]
  implicit val SubmitterType: Writes[SubmitterType] = Writes[SubmitterType] {
    t => JsString(t.toString)
  }
  ...
  implicit val ExplanationOnDelayForDeliveryType: OWrites[ExplanationOnDelayForDeliveryType] = Json.writes[ExplanationOnDelayForDeliveryType]
  ...
  implicit val LSDAssociatedInformationType: OWrites[LSDAssociatedInformationType] = Json.writes[LSDAssociatedInformationType]
  implicit val LSDSealInformationType: OWrites[LSDSealInformationType] = Json.writes[LSDSealInformationType]
  implicit val LSDComplementaryInformationTypeType: OWrites[LSDComplementaryInformationTypeType] = Json.writes[LSDComplementaryInformationTypeType]
  implicit val LSDEvidenceTypeComplementType: OWrites[LSDEvidenceTypeComplementType] = Json.writes[LSDEvidenceTypeComplementType]
  ...
  implicit val NewTransportArrangerTraderType: OWrites[NewTransportArrangerTraderType] = Json.writes[NewTransportArrangerTraderType]
  ...
  implicit val OtherAccompanyingDocumentTypeType: OWrites[OtherAccompanyingDocumentTypeType] = Json.writes[OtherAccompanyingDocumentTypeType]
  ...
  implicit val LSDReferenceOfSupportingDocumentTypeType: OWrites[LSDReferenceOfSupportingDocumentTypeType] = Json.writes[LSDReferenceOfSupportingDocumentTypeType]
  implicit val LSDSupportingDocumentDescriptionTypeType: OWrites[LSDSupportingDocumentDescriptionTypeType] = Json.writes[LSDSupportingDocumentDescriptionTypeType]
  implicit val LSDManualClosureRejectionComplementType: OWrites[LSDManualClosureRejectionComplementType] = Json.writes[LSDManualClosureRejectionComplementType]
  implicit val LSDManualClosureRequestReasonCodeComplementTypeType: OWrites[LSDManualClosureRequestReasonCodeComplementTypeType] = Json.writes[LSDManualClosureRequestReasonCodeComplementTypeType]
  implicit val LSDComplementaryInformationTypeType12: OWrites[LSDComplementaryInformationTypeType12] = Json.writes[LSDComplementaryInformationTypeType12]
  implicit val BodyManualClosureTypeType: OWrites[BodyManualClosureTypeType] = Json.writes[BodyManualClosureTypeType]
  implicit val SupportingDocumentsTypeType: OWrites[SupportingDocumentsTypeType] = Json.writes[SupportingDocumentsTypeType]
  ...
  implicit val StatusType: Writes[StatusType] = Writes[StatusType] {
    t => JsString(t.toString)
  }
  implicit val RequestedMessageType: Writes[RequestedMessageType] = Writes[RequestedMessageType] {
    t => JsString(t.toString)
  }
