...
import uk.gov.hmrc.excisemovementcontrolsystemapi.models.eis.{EISErrorMessage, EisHeaders}
...
(
  ...
  eisUtils: EmcsUtils,
  metrics: Metrics
)(implicit val ec: ExecutionContext) extends EisHeaders with ResponseHandler with Logging {
